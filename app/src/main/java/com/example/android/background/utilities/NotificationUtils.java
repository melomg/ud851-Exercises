...
public class NotificationUtils {
    private static final int WATER_REMINDER_PENDING_ID = 3417;
    ...
    public static void remindUserBecauseCharging(@NonNull Context context) {
    ...
    public static Bitmap largeIcon(@NonNull Context context) {
