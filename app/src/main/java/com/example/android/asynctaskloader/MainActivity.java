...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String EXTRA_SEARCH_RESULT = "raw_search";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            mUrlDisplayTextView.setText(savedInstanceState.getString(EXTRA_QUERY));
            mSearchResultsTextView.setText(savedInstanceState.getString(EXTRA_SEARCH_RESULT));
        }
    }
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(EXTRA_QUERY, url);
        ...
        outState.putString(EXTRA_SEARCH_RESULT, searchResults);
    }
}